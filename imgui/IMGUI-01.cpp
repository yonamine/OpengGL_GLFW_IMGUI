...
public:
    ...
    void Stop();
private:
    WNDCLASSEX wc;// @TODO CHECK HOW TO INITIALIZE WITH DEFAULT VALUE
    HWND hwnd; // @TODO CHECK HOW TO INITIALIZE WITH DEFAULT VALUE
...
void GameEngine::Initialize() {
    ...
    ConfigFlags = io.ConfigFlags; // @TODO TEMP
